...
### Hallazgo lateral, sin tocar (`/calendly-confirma/`)
...
`funnel_variant=VARIANTE-A` daría VA por error. **No se tocó**: excede el pedido y merece su
propia decisión.
...
Punta a punta sobre el servidor local:
